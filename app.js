...
mongoose.connect((process.env.DB_URL || 'mongodb+srv://mongo:hmD3qVOWpqKGSGqo@cluster0.84uktze.mongodb.net/course-hub?retryWrites=true&w=majority'), {
...
app.listen(PORT , () => {
    (`QUIZ APPLICATION IS NOW RUNNING ON PORT ${PORT}`);
});